...
CDownStairLeft::CDownStairLeft()
{
	this->Init();
}

CDownStairLeft::CDownStairLeft(Vector2 pos)
{
	this->Init();
	this->m_Pos = pos;
	this->m_typeHideObject = HideObject_TYPE::DownStairLeft;
}
...
void CDownStairLeft::Update(float deltaTime)
{
...
bool CDownStairLeft::SimonMoveOnStair(float deltaTime)
{
...
bool CDownStairLeft::SimonMoveOutStair(float deltaTime)
{
